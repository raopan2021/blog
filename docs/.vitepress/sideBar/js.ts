			...
			items: [
				{ text: '首页', link: 'index' },
				{
					...
					items: [
						...
						{ text: '油猴脚本', link: '油猴脚本' },
						{ text: 'addEventListener 和 onclick 区别', link: 'addEventListener和onclick区别' },
						{ text: 'Storage 和 Cookie', link: 'Storage和Cookie' },
						{ text: 'cookie 与 XSS/CSRF', link: 'cookie与XSS_CSRF' },
						{ text: 'for...in 和 for...of 的区别', link: 'for_in和for_of的区别' },
						{ text: 'DOM 节点操作常用方法', link: 'Dom节点操作常用方法' },
						{ text: 'Math 常用方法补充', link: 'Math常用方法' },
						{ text: 'setTimeout 倒计时误差', link: 'setTimeout倒计时误差' },
						{ text: '全屏', link: '全屏' },
						{ text: '前端性能优化', link: '前端性能优化' },
						{ text: '垃圾回收机制', link: '垃圾回收机制' },
						{ text: '如何区分 arr 和 obj', link: '如何区分arr和obj' },
						{ text: '滚动条自动滚动', link: '滚动条自动滚动' },
						{ text: '跨域及解决方案', link: '跨域及解决方案' },
						{ text: '页面特效', link: '页面特效' },
					],
				},
				{
					...
					items: [
						...
						{ text: 'var、let、const', link: 'var_let_const' },
						{ text: '解构赋值', link: '解构赋值' },
					],
				},
				{
				...
				},
				{
					...
					items: [
						...
						{ text: 'Object.create 和 new', link: 'Object.create和new' },
					],
				},
				{
					text: '函数',
					...
					items: [
						{ text: '闭包', link: '闭包' },
						{ text: '原型和原型链', link: '原型和原型链' },
						{ text: '事件循环 EventLoop', link: '事件循环EventLoop' },
						{ text: '防抖节流', link: '防抖节流' },
						{ text: 'call 和 apply 的模拟实现', link: 'call和apply的模拟实现' },
						{ text: 'bind 的模拟实现', link: 'bind的模拟实现' },
						{ text: 'bind、call、apply 的区别', link: 'bind_call_apply的区别' },
						{ text: 'new 原理', link: 'new原理' },
						{ text: '函数柯里化及其通用封装', link: '函数柯里化及其通用封装' },
						...
						{ text: '继承的多种方式和优缺点', link: '继承的多种方式和优缺点' },
						{ text: '递归', link: '递归' },
						{ text: '乱序', link: '乱序' },
					],
				},
